...
# ==============================================================================
# PROJECT AEGIS - CRYPTO EDITION (v4)
#
...
#   1) AegisTrader_Crypto_Day   -> Target_Day_Win
#   2) AegisTrader_Crypto_Swing -> Target_Swing_Win
#   3) AegisTrader_Crypto_Long  -> Target_Long_Win
# ==============================================================================

ALGORITHM_FAMILY_NAME = "AegisTrader_Crypto"
DATASET_NAME = "CRYPTO"
...
DATASET_PATH = (
    ...
    r"\DATASET_CRYPTO_ML_READY_v3.csv"
)
...
HORIZON_CONFIGS: Dict[str, Dict[str, Any]] = {
    "Day": {
        ...
        "model_name": "AegisTrader_Crypto_Day",
        "description": "Short-term crypto trading model for daily signals.",
        "look_forward": 3,
        "atr_mult": 1.5,
        "reward_to_risk": 2.0,
        "purge_gap_days": 3,
    ...
    "Swing": {
        ...
        "model_name": "AegisTrader_Crypto_Swing",
        "description": "Medium-term crypto trading model for within-week trading signals.",
        "look_forward": 14,
        "atr_mult": 2.5,
        "reward_to_risk": 3.0,
        "purge_gap_days": 14,
    ...
    "Long": {
        ...
        "model_name": "AegisTrader_Crypto_Long",
        "description": "Long-term crypto trading model for long-horizon positions.",
        "look_forward": 60,
        "atr_mult": 4.0,
        "reward_to_risk": 4.0,
        "purge_gap_days": 60,
...
try:
    ...
    raise ImportError(
        "Could not import 'ml_preprocessing_pipeline_v4.py'. Place it in the same folder as model_training_crypto_v4.py."
    ) from exc
...
def make_report_text(results: List[Dict[str, Any]]) -> str:
    lines: List[str] = []
    lines.append("=" * 100)
    lines.append("PROJECT AEGIS - CRYPTO EDITION (v4)")
...
def main() -> None:
    ...
    print_section_separator()
    print("[*] Loading dataset via ml_preprocessing_pipeline_v4.load_dataset('CRYPTO')")
    df = prep.load_dataset(DATASET_NAME)
    ...
    report_path = os.path.join(OUTPUT_BASE_DIR, f"Crypto_Model_Training_Evaluation_Results_v4_{timestamp}.txt")
    json_path = os.path.join(OUTPUT_BASE_DIR, f"Crypto_Model_Training_Summary_v4_{timestamp}.json")
